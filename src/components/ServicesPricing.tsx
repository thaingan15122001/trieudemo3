      ...
      <div className="container mx-auto px-6 sm:px-10 lg:px-16">
        <div className="max-w-[620px]">
          ...
          <p
            ...
            style={{ fontFamily: "'Inter', sans-serif" }}
          >
            Bảng giá cắt, uốn, nhuộm, duỗi và phục hồi tóc tại salon, Lái Thiêu, Thuận An. Mỗi dịch vụ được thực hiện tỉ mỉ với mức giá hợp lý, phù hợp cho cả khách hàng mới và khách quen.
          </p>
        </div>
