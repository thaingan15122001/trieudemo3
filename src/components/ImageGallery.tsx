...
const ImageGallery = () => {
  ...
  return (
    <section ref={sectionRef} id="lookbook" className="overflow-hidden bg-[#F8F5F0] pb-4 pt-20 sm:pb-6 sm:pt-20" aria-labelledby="lookbook-heading">
      <div className="container mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div ref={headerRef} className="grid items-end gap-8 lg:grid-cols-12 lg:gap-12">
          ...
          Trải nghiệm diện mạo mới với Salon của chúng tôi tại Lái Thiêu, nơi mỗi kiểu tóc được chăm chút theo cá tính, phong cách và đường nét riêng của bạn. Từ cắt, nhuộm đến tạo kiểu, chúng tôi giúp bạn tìm thấy mái tóc phù hợp và tự tin hơn mỗi ngày.
          </p>
        </div>
      </div>
